...
//            make.bottom.equalTo(self.mas_bottom);
        ...
        {
            make.left.equalTo(_dateDescLabel.mas_right).with.offset(10);
            make.top.equalTo(self.mas_top);
//            make.bottom.equalTo(self.mas_bottom);
        }];
        ...
        [_openLabel mas_makeConstraints:^(MASConstraintMaker *make)
         {
            make.left.equalTo(_openDescLabel.mas_right).with.offset(2);
            make.top.equalTo(self.mas_top);
//            make.bottom.equalTo(self.mas_bottom);
        }];
        ...
        {
            make.left.equalTo(_openLabel.mas_right).with.offset(10);
            make.top.equalTo(self.mas_top);
//            make.bottom.equalTo(self.mas_bottom);
        }];
        ...
        [_highLabel mas_makeConstraints:^(MASConstraintMaker *make)
         {
            make.left.equalTo(_highDescLabel.mas_right).with.offset(2);
            make.top.equalTo(self.mas_top);
//            make.bottom.equalTo(self.mas_bottom);
        ...
        {
            make.left.equalTo(_highLabel.mas_right).with.offset(10);
            make.top.equalTo(self.mas_top);
//            make.bottom.equalTo(self.mas_bottom);
        }];
        ...
        {
            make.left.equalTo(_lowDescLabel.mas_right).with.offset(2);
            make.top.equalTo(self.mas_top);
//            make.bottom.equalTo(self.mas_bottom);
        }];
        
        [_closeDescLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(_lowLabel.mas_right).with.offset(10);
            make.top.equalTo(self.mas_top);
//            make.bottom.equalTo(self.mas_bottom);
        }];
        ...
        [_closeLabel mas_makeConstraints:^(MASConstraintMaker *make)
         {
            make.left.equalTo(_closeDescLabel.mas_right).with.offset(2);
            make.top.equalTo(self.mas_top);
//            make.bottom.equalTo(self.mas_bottom);
        }];
        
        [_MA7Label mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(_dateDescLabel.mas_left);
            make.top.equalTo(_dateDescLabel.mas_bottom).with.offset(5);
            make.bottom.equalTo(self.mas_bottom);
            
        }];
        
        [_MA30Label mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(_MA7Label.mas_right).with.offset(10);
...
- (UILabel *)private_createLabel
{
    ...
    label.backgroundColor = NavBarBackColor;
